...
Koncept je validiran kroz probne krugove DENT-016–020 (implementacija:
Crush, Pi, Codex) i tri Codex review runde — `.agent/` sloj mjerljivo
smanjuje istraživačke pozive (`ls`/`find`) kad task brief ne navodi
eksplicitno šta čitati. Puna probna tabela, metodologija i nalazi po krugu:
